...
const isRefObject = (
    ...
    return value
        ? 'current' in value && typeof value.current === 'object' && value.current !== null
        : false;
};
...
class DragOverLayout extends ReactGridLayout {
    declare props: DragOverLayoutProps;
    declare state: DragOverLayoutState;
    ...
    getInnerElement(): HTMLDivElement | null {
        ...
        return innerRef && isRefObject(innerRef) ? innerRef.current || null : null;
    }
...
export const Layout = WidthProvider(DragOverLayout) as React.ComponentClass<
    DragOverLayoutProps & ReactGridLayout.WidthProviderProps
>;
